...
/* VK_Buffer must be set with device & size prior to calling this constructor */
...
bool vk_buff_copy(const Vk_Cmd_Man *cmd_man, VkQueue queue, Vk_Buffer src, Vk_Buffer dst, VkDeviceSize size);
