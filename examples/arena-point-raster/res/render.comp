...
#define MODE_MULTI_VID_TEX                    4
#define MODE_MULTI_VID_TEX_BLEND              5
#define MODE_VERT_COLORED_BY_CCTV             6
#define MODE_VERT_CLOSEST_CCTV_TEX            7
#define MODE_VERT_CLOSEST_CCTV_TEX_W_FALLBACK 8
